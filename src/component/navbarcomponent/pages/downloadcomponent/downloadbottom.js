    ...
    <div data-aos='fade-up' className=' flex flex-col justify-center items-center w-full m-auto text1 lg:p-20 lg:pt-10  md:p-16 md:pt-8 sm:p-10 sm:pt-5 p-5 ' >
        ...
        <div className=' flex flex-col m-auto  text-base'>
            <div className=' flex flex-row border  border-b-0 bg-gray-200 shadow-inner ' >
                <div className=' w-1/4 m-auto   text-center hover:text-gray-500 cursor-pointer '>
                    Operating System
                </div>
                <div className=' w-3/4 bg-gray-200 '>
                    <ul className=' text-left z-10 lg:leading-10 md:leading-10 leading-8 mt-0 inline-block border-l-2 p-2  '>
                        ...
                        <li className='hover:shadow-md'> <i class="fa-solid fa-circle"></i>Other OS may support Storlytics installation and execution but no guarantee can be provided. This effectively depends on many parameters….
                        </li>
            ...
            <div className='flex flex-row border  border-b-0 shadow-inner'>
                <div className=' w-1/4 m-auto flex-wrap text-center'>
                OS not supported: 
                </div>
                <div className=' w-3/4 '>
                    <ul className=' text-left z-10 lg:leading-10 md:leading-10 leading-8 mt-0 inline-block border-l-2 p-2'>
               ...
               <div> Other requirements</div>
                ...
                <div className=' w-3/4 '>
                    <ul className=' text-left z-10 lg:leading-10 md:leading-10 leading-8 mt-0 inline-block border-l-2 p-2 '>
                        ...
                        <li className='hover:shadow-md '> <i class="fa-solid fa-circle"></i>Minimal screen resolution of 1280 x 720 pixels
                        </li>
                        <li className='hover:shadow-md '> <i class="fa-solid fa-circle"></i>.NET 4.8 framework (for Meteonorm)
                        </li>
                        <li className='hover:shadow-md '> <i class="fa-solid fa-circle"></i>Graphics card supporting OpenGL 2.0 or higher
                        </li>
                        <li className='hover:shadow-md'> <i class="fa-solid fa-circle"></i>Storlytics workspace does not support shared or remotely synced drives / folders (including OneDrive, Google Drive, Dropbox, etc…). Files and workspaces can be synced as a separate task, once Storlytics has been closed.
                        </li>
