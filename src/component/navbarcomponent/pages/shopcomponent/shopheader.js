...
function Header() {
    return ( <div> 
      <div className=' w-full absolute -z-10  '> <img className=' opacity-60 img1 w-full lg:max-h-fit' src={shopcover} /> </div>


<div className=' flex flex-col flex-wrap m-auto container text-center md:mb-32 sm:mb-32 mb-32  '>

    <h1 className='container shop-page-heading  lg:text-3xl md:text-2xl sm:text-2xl text-lg font-semibold  lg:mb-4 w-full lg:mt-72   lg:pl-14 md:mt-60  sm:mt-72 heading mt-72 '>
