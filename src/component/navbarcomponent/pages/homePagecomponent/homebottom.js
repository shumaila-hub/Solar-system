    ...
    return (<div className=' '>
        <div className=' w-full  lg:flex lg:flex-row md:flex md:flex-col flex-wrap  '>
            <div className=' lg:w-1/2 md:flex md:flex-col md:w-full sm:w-full sm:mt-10    '>
                <div className='lg:p-20 lg:pt-0 lg:pr-0 md:p-10 sm:p-10  p-5 lg:mt-0 '>
                    ...
                    <p className=' list-outside textcolor text-left z-10 leading-8 flow-root ' >
            ...
            <div className=' lg:w-1/2 md:w-full lg:h-full lg:mt-32  '>
                <img className=' lg:pr-24 w-auto md:p-20 sm:p-10 p-5  xl:pt-0  ' src={homebottomimg} />
            </div>
