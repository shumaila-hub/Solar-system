...
function MidSection() {
    return (<div className=' 2xl:mt-0 xl:mt-0 xl:p-20 lg:p-20 2xl:p-40 2xl:pb-20 p-5 lg:mt-0 md:mt-0   sm:p-10 sm:mt-0 md:p-10  mt-10'>
        <div className=' w-full  lg:flex lg:flex-row md:flex md:flex-col flex-wrap '>
            <div className=' lg:w-1/2 md:flex md:flex-col md:w-full sm:w-full   '>
                <div className='   md:mt-0 sm:mt-0  mt-5  xl:pr-10 lg:pr-5 lg:pl-5'>
            ...
            <div className=' lg:w-1/2 md:w-full md:mt-10 sm:mt-5   mt-5  '>
                <img className='   xl:mt-14 lg:mt-10 lg:h-3/4 2xl:mt-0 ' src={oursoftware} />
            </div>
