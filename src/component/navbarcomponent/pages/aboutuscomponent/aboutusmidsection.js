...
function Midsec() {
    return (<div>
        <div className='lg:h-3/4 w-full  lg:flex lg:flex-row md:flex md:flex-col flex-wrap lg:p-16 lg:pb-0 md:p-14 sm:p-10 p-6'>
        ...
        <div className='w-full lg:flex lg:flex-row inline-block lg:p-16 lg:pt-0 md:p-14 md:pt-0 p-6 pt-0 sm:p-10 sm:pt-0 '>
            <div className=' lg:w-1/2  '>
