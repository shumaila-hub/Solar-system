     ...
     <div onClick={handleClick} className={click ? 'dropdown-menu clicked' : 'dropdown-menu'}>
      ...
      <div className='flex flex-row w-full leading-10 p-5  '>
        ...
        <div className=' w-1/2 text-white p-10 justify-start border-r-2 border-white'>
          <div className='xl:text-2xl lg:text-2xl 2xl:text-3xl font-semibold mt-3  '> <a href='/aboutus'>Download</a></div>
          ...
          <div>
            <button className=' text-base font-semibold border-2 border-sky-600 rounded-lg p-3 pl-5 pr-5 mt-5 hover:bg-gradient-to-r from-blue-800 to-blue-600  hover:shadow-lg hover:shadow-blue-600'  > <a href='/aboutus'>Click to Download </a>  </button>
          </div>
        </div>
        <div className='flex flex-col w-1/2 mt-3 text-center justify-center text-white items-center ' >
          <div className='flex flex-row mt-3 '>
            <div className=' w-full flex flex-col xl:p-16 2xl:p-0 '>
              ...
              <div className='mt-3'> <p> Installation Requirements </p></div>
            </div>
        ...
        <div className=' w-1/4 text-white p-5 justify-start border-l-2 border-white '>
          ...
          <div className=' text-xl font-semibold mt-3  '> <a href='/aboutus'>Required Computer Configurations
          </a></div>
